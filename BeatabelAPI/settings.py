"""
Django settings for BeatabelAPI project.
...
ROOT_URLCONF = 'BeatabelAPI.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'BeatabelAPI/../main_app/staticfiles/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'BeatabelAPI.wsgi.application'
